...
export default function Home() {
  ...
  const handlePreloaderComplete = useCallback(() => {
    // Only hide preloader if video is ready, otherwise wait
    if (videoReady) {
      setIsLoading(false);
    } else {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 p-2">
          ...
          <div className="relative overflow-hidden rounded-xl flex-1">
            ...
            <div className="absolute top-0 right-0 z-50 h-full w-full pointer-events-none">
              <StaggeredMenu
                ...
                colors={['#0a192f', '#112240', '#0a192f']} // Navy deep blue theme
                accentColor="#0a192f" // Dark navy blue accent
                logoUrl="" // We use our own logo
